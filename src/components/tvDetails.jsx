...
import { asynchloadtv, removetv } from "../store/actions/tvAction";
import {
  Link,
  Outlet,
  useLocation,
...
const tvDetails = () => {
  ...
  return info && info.details ? (
    <div
      ...
      className="w-screen h-[120vh]  px-14 relative"
    >
      {/*  part 1 navigayion  */}
      ...
      <div className=" w-full flex ">
        <img
          className="h-[40vh] object-cover shadow-lg shadow-black rounded-lg"
